...
##  [/BookingMobile.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BookingMobile.Client)
...
## [/BookingMobile](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BookingMobile)

The .NET 6 `/BookingMobile` backend server is required for this App's dynamic functions including the Hello API on the home page
